...
(function(factory) {
   ...
   *
   * <h2 ion-text color="light">h2: The quick brown fox jumps over the lazy dog</h2>
   *
  ...
  var Typography = (function(_super) {
    ...
    /** @nocollapse */
    Typography.ctorParameters = function() {
      return [{ type: config_1.Config }, { type: core_1.ElementRef }, { type: core_1.Renderer }];
    };
    return Typography;
  })(ion_1.Ion);
